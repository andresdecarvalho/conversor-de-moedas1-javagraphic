...
public class ConversorMoedas extends JFrame {
	...
	public ConversorMoedas() {
		...
		lblDolarEuro.setBounds(259, 70, 86, 14);
	...
	private void calcular() {
		...
		real = Double.parseDouble(txtReal.getText().replace(",","."));
		cotacao = Double.parseDouble(txtCotacao.getText().replace(",","."));
		dolar = real * cotacao;
		txtDolar.setText(formatador.format(dolar));
